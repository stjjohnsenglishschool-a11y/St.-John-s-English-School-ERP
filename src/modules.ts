...
export const modules: Record<string, Module> = {
  ...
  'student_master': {
    ...
    description: 'Complete student admission, academic, parent profiles and Google Drive photo archive',
    fields: [
  ...
  'employee_master': {
    ...
    fields: [
      ...
      f('employment_status', 'Employment status', 'select', false, ['Active', 'Resigned', 'Inactive', 'Terminated', 'On Leave', 'Suspended', 'Retired']),
      f('academic_year', 'Academic year', 'select', false, ACADEMIC_YEAR_OPTIONS),
      ...
      f('resignation_date', 'Resignation date', 'date'),
      f('last_working_date', 'Last working date', 'date'),
  ...
  'salary_slip': {
    ...
    fields: [
      ...
      f('resignation_settlement', 'Final settlement / Resignation salary', 'boolean'),
      f('remarks', 'Settlement remarks / notes', 'textarea'),
