      ...
      if (!matchedUser) {
        if (login.toLowerCase() === 'admin' || login.toLowerCase() === 'admin@stjohns.edu') {
          ...
          matchedUser = {
            ...
            role: 'principal',
            allowed_modules: ['school_master', 'department_master', 'class_master', 'fees_structure', 'income_head_master', 'student_master', 'employee_master', 'student_attendance', 'employee_attendance', 'fees_collection', 'income_master', 'notice_automation'],
          }
